...
if($_GET['tn'] == 'uploadfile'){
    echo '<!DOCTYPE html><html><head><script>parent.__uploadFileCallback__("./img/jizhi/comment_head.png");</script></head><body></body></html>';
    abort(0);
}
...
//'http://cq01-testing-news23.vm.baidu.com:8080/news?' . $query_string, false, $context
//'http://cp01-rdqa-dev334.cp01.baidu.com:8999/news?' . $query_string, false, $context
// 'http://db-news-fe3.vm.baidu.com:8090/news?' . $query_string, false, $context
//'http://cq01-testing-news22.vm.baidu.com:8091/news?' . $query_string, false, $context
);
